...
- Include unresolved index paths in the working-tree count even when their saved filesystem content matches HEAD. During a merge or rebase, supplement the row with the operation and conflict count, and group the inspection list as Merge Changes and Changes.
