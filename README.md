...
- Marks local and remote HEAD positions with an unbordered icon-and-text `HEAD` indicator, labels local and remote `main` or `master` positions independently, and keeps other refs compact through fill and shape
