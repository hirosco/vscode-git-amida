...
- Shows a compact graph, non-wrapping subject, date, and complete wrapping ref chips for each commit
- Marks the checked-out HEAD independently from the commit subject
